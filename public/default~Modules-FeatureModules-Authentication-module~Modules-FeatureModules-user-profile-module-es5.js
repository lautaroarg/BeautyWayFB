(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~Modules-FeatureModules-Authentication-module~Modules-FeatureModules-user-profile-module"], {
    /***/
    "v5XD":
    /*!*******************************************!*\
      !*** ./src/app/Models/c-states-cities.ts ***!
      \*******************************************/

    /*! exports provided: StatesCitiesType, cStatesCities */

    /***/
    function v5XD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StatesCitiesType", function () {
        return StatesCitiesType;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "cStatesCities", function () {
        return cStatesCities;
      });

      var StatesCitiesType = /*#__PURE__*/_createClass(function StatesCitiesType() {
        _classCallCheck(this, StatesCitiesType);
      });

      var cStatesCities = /*#__PURE__*/_createClass(function cStatesCities() {
        _classCallCheck(this, cStatesCities);
        ...
        this.StatesCities = [{
          ...
          State: "Bihar",
          Cities: ["Araria", "Arrah", "Arwal", "Asarganj", "Aurangabad", "Bagaha", "Barh", "Begusarai", "Bettiah", "Bhabua", "Bhagalpur", "Buxar", "Chhapra", "Darbhanga", "Dehri-on-Sone", "Dumraon", "Forbesganj", "Gaya", "Gopalganj", "Hajipur", "Jamalpur", "Jamui", "Jehanabad", "Katihar", "Kishanganj", "Lakhisarai", "Lalganj", "Madhepura", "Madhubani", "Maharajganj", "Mahnar Bazar", "Makhdumpur", "Maner", "Manihari", "Marhaura", "Masaurhi", "Mirganj", "Mokameh", "Motihari", "Motipur", "Munger", "Murliganj", "Muzaffarpur", "Narkatiaganj", "Naugachhia", "Nawada", "Nokha", "Patna*", "Piro", "Purnia", "Rafiganj", "Rajgir", "Ramnagar", "Raxaul Bazar", "Revelganj", "Rosera", "Saharsa", "Samastipur", "Sasaram", "Sheikhpura", "Sheohar", "Sherghati", "Silao", "Sitamarhi", "Siwan", "Sonepur", "Sugauli", "Sultanganj", "Supaul", "Warisaliganj"]
        }, {
          State: "Chandigarh",
          Cities: ["Chandigarh*"]
        }, {
...
//# sourceMappingURL=default~Modules-FeatureModules-Authentication-module~Modules-FeatureModules-user-profile-module-es5.js.map